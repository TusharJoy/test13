  ...
  // line 35 "model.ump"
   public static  void main(String [] args){
    ...
    for(int i=0;i<32;i++)
    {
    	...
    	Student s1=new Student(sname);
    	s1.setMentor(m);
    	if(m.numberOfStudents()<15)
    	{
    		s1.setMentor(m);
    		System.out.println("The mentor of "  + s1  + " is " +  s.getMentor());
    	}
    	else
    	{
    		System.out.println("number of stusent is greater than 15");
    		break;
    	}
